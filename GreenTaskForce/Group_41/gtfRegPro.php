  ...
  <tr>
	...
	if($conn){
		...
		if(mysqli_query($conn,$queSave)){
			echo '<p align="center">'.$fn.' successfully SAVE to the Database!<br><a href="gtfLogin.html"><img src="Imgs/back-icon.png" width="64px" height="64px"></a></p>';
										}
			else{
			...
			echo 'Password & Retype Password is Not Match!<br><a href="gtfReg.html"><img src="Imgs/back-Icon.png" width="64px" height="64px"></a>';
			}
					 }
	else{
