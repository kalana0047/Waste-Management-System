...
<table width="95%" border="0" align="center" cellpadding="5" cellspacing="0">
  ...
  <tr>
	...
	$conn=mysqli_connect('localhost','root','','db_group_41');
			...
			$queSel="SELECT * FROM gtf_master_data WHERE Status='Not Approved'";
					...
					echo '<table width="80%" align="center" boarder="0" cellpadding="5" cellspacing="0">
						...
						while($rowVal=mysqli_fetch_assoc($dataRes)){
							echo '<tr>
									...
									<td>'.$rowVal['Status'].'</td>
									<td><a href="DataProcess.php?id='.$rowVal['Serial'].'"><img src="Imgs/btnView.png" width="100" height="34"></a></td>
								  </tr>';
																	}
					echo '</table>';
												}
